...
namespace CustomerApp {
    ...
    public partial class CustomerDBDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomerRow AddCustomerRow(string First_Name, string Last_Name, string Email, string CNIC, string Phone) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomerRow FindByCNIC(string CNIC) {
...
namespace CustomerApp.CustomerDBDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customer] WHERE (((@IsNull_First_Name = 1 AND [First_Name] IS NULL) OR ([First_Name] = @Original_First_Name)) AND ((@IsNull_Last_Name = 1 AND [Last_Name] IS NULL) OR ([Last_Name] = @Original_Last_Name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([CNIC] = @Original_CNIC) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([First_Name], [Last_Name], [Email], [CNIC], [Phone]" +
                ") VALUES (@First_Name, @Last_Name, @Email, @CNIC, @Phone);\r\nSELECT First_Name, L" +
                "ast_Name, Email, CNIC, Phone FROM Customer WHERE (CNIC = @CNIC)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [First_Name] = @First_Name, [Last_Name] = @Last_Name, [Email] = @Email, [CNIC] = @CNIC, [Phone] = @Phone WHERE (((@IsNull_First_Name = 1 AND [First_Name] IS NULL) OR ([First_Name] = @Original_First_Name)) AND ((@IsNull_Last_Name = 1 AND [Last_Name] IS NULL) OR ([Last_Name] = @Original_Last_Name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([CNIC] = @Original_CNIC) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT First_Name, Last_Name, Email, CNIC, Phone FROM Customer WHERE (CNIC = @CNIC)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CustomerApp.Properties.Settings.Default.CustomerDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT First_Name, Last_Name, Email, CNIC, Phone FROM dbo.Customer";
        ...
        public virtual int Delete(string Original_First_Name, string Original_Last_Name, string Original_Email, string Original_CNIC, string Original_Phone) {
        ...
        public virtual int Insert(string First_Name, string Last_Name, string Email, string CNIC, string Phone) {
            if ((First_Name == null)) {
        ...
        public virtual int Update(string First_Name, string Last_Name, string Email, string CNIC, string Phone, string Original_First_Name, string Original_Last_Name, string Original_Email, string Original_CNIC, string Original_Phone) {
            if ((First_Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string First_Name, string Last_Name, string Email, string Phone, string Original_First_Name, string Original_Last_Name, string Original_Email, string Original_CNIC, string Original_Phone) {
            return this.Update(First_Name, Last_Name, Email, Original_CNIC, Phone, Original_First_Name, Original_Last_Name, Original_Email, Original_CNIC, Original_Phone);
        }
    }
